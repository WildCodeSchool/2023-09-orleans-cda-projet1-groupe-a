  ...
  return (
    <>
      <div className="relative m-0 h-[390vh] bg-[#f4f4f0] p-0 md:h-[350vh] 2xl:h-[290vh]">
        <div className="absolute left-1/2 top-56 z-10 h-[25vh] w-[20vh] -translate-x-1/2 -translate-y-1/2 transform md:h-[33vh] md:w-[28vh] lg:h-[50vh] lg:w-[40vh] 2xl:h-[50vh] 2xl:w-[40vh]">
          <motion.img
            src={home5}
        ...
        <div className="absolute left-[38%] top-64 z-30  h-[25vh] w-[20vh] -translate-x-1/2 -translate-y-1/2 transform md:h-[33vh] md:w-[28vh] lg:h-[50vh] lg:w-[40vh] 2xl:h-[50vh] 2xl:w-[40vh]">
          <motion.img
            src={home3}
            className="h-full w-full object-cover shadow-md"
            style={{
        ...
        <div className="absolute left-[64%] top-64 z-20  -translate-x-1/2 -translate-y-1/2 transform md:h-[33vh] md:w-[28vh] lg:h-[91vh] lg:w-[40vh] 2xl:h-[50vh] 2xl:w-[40vh]">
          <motion.img
            src={home4}
        ...
        <div className="absolute left-[28%] top-[49vh] z-30  h-[25vh] w-[20vh] -translate-x-1/2 -translate-y-1/2 transform md:h-[40vh] md:w-[83vh] lg:h-[39vh] lg:w-[81vh] 2xl:h-[40vh] 2xl:w-[22vh]">
          <motion.img
            className="h-full w-full object-cover shadow-md"
            src={home6}
            style={{
